...
System.out.print ("Enter the performance rating (only Excellent, Good, or Poor will be accepted): ");
rating = scan.next();
...
if( rating.equals("Excellent")){raise= currentSalary * .06;}
        ...
        else{ System.out.println("your input was invalid (try capitalizing the first letter)"); raise = 0;}
